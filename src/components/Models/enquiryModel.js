          ...
          <div class="modal-content rounded-0 p-2">
            ...
            <div class="modal-body">
              <div class="" id="formSection">
                ...
                <div class="mt-3 pb-2">
                  <button
                    class="model-submitBtn fw-semibold"
                    id="enquirySubmitBtn"
                  >
                    Submit
                  </button>
              ...
              <div class="d-none" id="successSection">
                <p class="model-p">
                  ...
                  urgency, feel free to connect over WhatsApp for faster
                  response.
                </p>
                <div class="mt-3 pb-2">
                  <button
                    class="model-submitBtn-success d-flex align-items-center justify-content-center whatsapp-link"
                    style={{ height: 60 }}
                  >
                    <span class="d-block">Chat with us on whatsapp</span>
                    <img
                      src="/assets/images/wa-icon.svg"
                      height="25px"
                      class="ms-1"
                    />
                  </button>
                  ...
                  >
                    Prefer calling? Dial
                    [['+'+Business.countrycode]][[Business.contacts[0].contactnumber]]
                    (International callers) or{" "}
                    <a href="tel:[[Business.contacts[0].contacttype.tolower() == 'vmn' ? '' : '+'+Business.countrycode ]][[Business.contacts[0].contactnumber]]">
